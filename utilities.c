 ...
 */
  ...
  *((double *) ( /* dim=2 */ (( /* dim=1 */ (( /* dim=0 */ (__pyx_v_flux_array.data + __pyx_t_28 * __pyx_v_flux_array.strides[0]) ) + __pyx_t_27 * __pyx_v_flux_array.strides[1]) ) + __pyx_t_26 * __pyx_v_flux_array.strides[2]) )) = ((((*((double *) ( /* dim=2 */ (( /* dim=1 */ (( /* dim=0 */ (__pyx_v_drift_at_pos.data + __pyx_t_25 * __pyx_v_drift_at_pos.strides[0]) ) + __pyx_t_24 * __pyx_v_drift_at_pos.strides[1]) ) + __pyx_t_23 * __pyx_v_drift_at_pos.strides[2]) ))) * (*((double *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_p_now.data + __pyx_t_22 * __pyx_v_p_now.strides[0]) ) + __pyx_t_21 * __pyx_v_p_now.strides[1]) )))) - ((((*((double *) ( /* dim=2 */ (( /* dim=1 */ (( /* dim=0 */ (__pyx_v_diffusion_at_pos.data + __pyx_t_20 * __pyx_v_diffusion_at_pos.strides[0]) ) + __pyx_t_19 * __pyx_v_diffusion_at_pos.strides[1]) ) + __pyx_t_18 * __pyx_v_diffusion_at_pos.strides[2]) ))) * (*((double *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_p_now.data + __pyx_t_17 * __pyx_v_p_now.strides[0]) ) + __pyx_t_16 * __pyx_v_p_now.strides[1]) )))) - ((*((double *) ( /* dim=2 */ (( /* dim=1 */ (( /* dim=0 */ (__pyx_v_diffusion_at_pos.data + __pyx_t_15 * __pyx_v_diffusion_at_pos.strides[0]) ) + __pyx_t_14 * __pyx_v_diffusion_at_pos.strides[1]) ) + __pyx_t_13 * __pyx_v_diffusion_at_pos.strides[2]) ))) * (*((double *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_p_now.data + __pyx_t_12 * __pyx_v_p_now.strides[0]) ) + __pyx_t_11 * __pyx_v_p_now.strides[1]) ))))) / (2.0 * __pyx_v_dx))) - ((((*((double *) ( /* dim=2 */ (( /* dim=1 */ (( /* dim=0 */ (__pyx_v_diffusion_at_pos.data + __pyx_t_10 * __pyx_v_diffusion_at_pos.strides[0]) ) + __pyx_t_9 * __pyx_v_diffusion_at_pos.strides[1]) ) + __pyx_t_8 * __pyx_v_diffusion_at_pos.strides[2]) ))) * (*((double *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_p_now.data + __pyx_t_7 * __pyx_v_p_now.strides[0]) ) + __pyx_t_6 * __pyx_v_p_now.strides[1]) )))) - ((*((double *) ( /* dim=2 */ (( /* dim=1 */ (( /* dim=0 */ (__pyx_v_diffusion_at_pos.data + __pyx_t_5 * __pyx_v_diffusion_at_pos.strides[0]) ) + __pyx_t_4 * __pyx_v_diffusion_at_pos.strides[1]) ) + __pyx_t_3 * __pyx_v_diffusion_at_pos.strides[2]) ))) * (*((double *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_p_now.data + __pyx_t_2 * __pyx_v_p_now.strides[0]) ) + __pyx_t_1 * __pyx_v_p_now.strides[1]) ))))) / (2.0 * __pyx_v_dx)));
 ...
 */
  __pyx_t_8 = 0;
  __pyx_t_7 = (__pyx_v_N - 1);
  *((double *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_out_array.data + __pyx_t_8 * __pyx_v_out_array.strides[0]) ) + __pyx_t_7 * __pyx_v_out_array.strides[1]) )) = ((((*((double *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_p_now.data + __pyx_t_6 * __pyx_v_p_now.strides[0]) ) + __pyx_t_5 * __pyx_v_p_now.strides[1]) ))) / (*((double *) ( /* dim=0 */ (__pyx_v_marginal_now.data + __pyx_t_4 * __pyx_v_marginal_now.strides[0]) )))) - ((*((double *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_p_now.data + __pyx_t_3 * __pyx_v_p_now.strides[0]) ) + __pyx_t_2 * __pyx_v_p_now.strides[1]) ))) / (*((double *) ( /* dim=0 */ (__pyx_v_marginal_now.data + __pyx_t_1 * __pyx_v_marginal_now.strides[0]) ))))) / (2.0 * __pyx_v_dx));
 ...
 */
  ...
  *((double *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_p_now.data + __pyx_t_44 * __pyx_v_p_now.strides[0]) ) + __pyx_t_43 * __pyx_v_p_now.strides[1]) )) = ((*((double *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_p_last.data + __pyx_t_42 * __pyx_v_p_last.strides[0]) ) + __pyx_t_41 * __pyx_v_p_last.strides[1]) ))) + (__pyx_v_dt * ((((-(((*((double *) ( /* dim=2 */ (( /* dim=1 */ (( /* dim=0 */ (__pyx_v_drift_at_pos.data + __pyx_t_40 * __pyx_v_drift_at_pos.strides[0]) ) + __pyx_t_39 * __pyx_v_drift_at_pos.strides[1]) ) + __pyx_t_38 * __pyx_v_drift_at_pos.strides[2]) ))) * (*((double *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_p_last.data + __pyx_t_37 * __pyx_v_p_last.strides[0]) ) + __pyx_t_36 * __pyx_v_p_last.strides[1]) )))) - ((*((double *) ( /* dim=2 */ (( /* dim=1 */ (( /* dim=0 */ (__pyx_v_drift_at_pos.data + __pyx_t_35 * __pyx_v_drift_at_pos.strides[0]) ) + __pyx_t_34 * __pyx_v_drift_at_pos.strides[1]) ) + __pyx_t_33 * __pyx_v_drift_at_pos.strides[2]) ))) * (*((double *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_p_last.data + __pyx_t_32 * __pyx_v_p_last.strides[0]) ) + __pyx_t_31 * __pyx_v_p_last.strides[1]) )))))) / (2.0 * __pyx_v_dx)) + (((((*((double *) ( /* dim=2 */ (( /* dim=1 */ (( /* dim=0 */ (__pyx_v_diffusion_at_pos.data + __pyx_t_30 * __pyx_v_diffusion_at_pos.strides[0]) ) + __pyx_t_29 * __pyx_v_diffusion_at_pos.strides[1]) ) + __pyx_t_28 * __pyx_v_diffusion_at_pos.strides[2]) ))) * (*((double *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_p_last.data + __pyx_t_27 * __pyx_v_p_last.strides[0]) ) + __pyx_t_26 * __pyx_v_p_last.strides[1]) )))) - ((2.0 * (*((double *) ( /* dim=2 */ (( /* dim=1 */ (( /* dim=0 */ (__pyx_v_diffusion_at_pos.data + __pyx_t_25 * __pyx_v_diffusion_at_pos.strides[0]) ) + __pyx_t_24 * __pyx_v_diffusion_at_pos.strides[1]) ) + __pyx_t_23 * __pyx_v_diffusion_at_pos.strides[2]) )))) * (*((double *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_p_last.data + __pyx_t_22 * __pyx_v_p_last.strides[0]) ) + __pyx_t_21 * __pyx_v_p_last.strides[1]) ))))) + ((*((double *) ( /* dim=2 */ (( /* dim=1 */ (( /* dim=0 */ (__pyx_v_diffusion_at_pos.data + __pyx_t_20 * __pyx_v_diffusion_at_pos.strides[0]) ) + __pyx_t_19 * __pyx_v_diffusion_at_pos.strides[1]) ) + __pyx_t_18 * __pyx_v_diffusion_at_pos.strides[2]) ))) * (*((double *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_p_last.data + __pyx_t_17 * __pyx_v_p_last.strides[0]) ) + __pyx_t_16 * __pyx_v_p_last.strides[1]) ))))) / (__pyx_v_dx * __pyx_v_dx))) + (((((*((double *) ( /* dim=2 */ (( /* dim=1 */ (( /* dim=0 */ (__pyx_v_diffusion_at_pos.data + __pyx_t_15 * __pyx_v_diffusion_at_pos.strides[0]) ) + __pyx_t_14 * __pyx_v_diffusion_at_pos.strides[1]) ) + __pyx_t_13 * __pyx_v_diffusion_at_pos.strides[2]) ))) * (*((double *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_p_last.data + __pyx_t_12 * __pyx_v_p_last.strides[0]) ) + __pyx_t_11 * __pyx_v_p_last.strides[1]) )))) - ((2.0 * (*((double *) ( /* dim=2 */ (( /* dim=1 */ (( /* dim=0 */ (__pyx_v_diffusion_at_pos.data + __pyx_t_10 * __pyx_v_diffusion_at_pos.strides[0]) ) + __pyx_t_9 * __pyx_v_diffusion_at_pos.strides[1]) ) + __pyx_t_8 * __pyx_v_diffusion_at_pos.strides[2]) )))) * (*((double *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_p_last.data + __pyx_t_7 * __pyx_v_p_last.strides[0]) ) + __pyx_t_6 * __pyx_v_p_last.strides[1]) ))))) + ((*((double *) ( /* dim=2 */ (( /* dim=1 */ (( /* dim=0 */ (__pyx_v_diffusion_at_pos.data + __pyx_t_5 * __pyx_v_diffusion_at_pos.strides[0]) ) + __pyx_t_4 * __pyx_v_diffusion_at_pos.strides[1]) ) + __pyx_t_3 * __pyx_v_diffusion_at_pos.strides[2]) ))) * (*((double *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_p_last.data + __pyx_t_2 * __pyx_v_p_last.strides[0]) ) + __pyx_t_1 * __pyx_v_p_last.strides[1]) ))))) / (__pyx_v_dx * __pyx_v_dx)))));
 ...
 */
  ...
  for (__pyx_t_47 = 1; __pyx_t_47 < __pyx_t_46; __pyx_t_47+=1) {
 ...
 */
    ...
    __pyx_t_38 = 1;
    __pyx_t_39 = __pyx_v_i;
    __pyx_t_40 = (__pyx_v_N - 2);
    __pyx_t_41 = __pyx_v_i;
    __pyx_t_42 = (__pyx_v_N - 2);
 ...
 *     double[:, :] p_now,
 */
  __pyx_tuple__20 = PyTuple_Pack(7, __pyx_n_s_positions, __pyx_n_s_p_now, __pyx_n_s_drift_at_pos, __pyx_n_s_diffusion_at_pos, __pyx_n_s_flux_array, __pyx_n_s_N, __pyx_n_s_dx); if (unlikely(!__pyx_tuple__20)) __PYX_ERR(0, 8, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_tuple__20);
  __Pyx_GIVEREF(__pyx_tuple__20);
  __pyx_codeobj__21 = (PyObject*)__Pyx_PyCode_New(7, 0, 7, 0, CO_OPTIMIZED|CO_NEWLOCALS, __pyx_empty_bytes, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_tuple__20, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_kp_s_utilities_pyx, __pyx_n_s_calc_flux, 8, __pyx_empty_bytes); if (unlikely(!__pyx_codeobj__21)) __PYX_ERR(0, 8, __pyx_L1_error)
 ...
 *     double[:, :] Ly,
 */
  __pyx_tuple__22 = PyTuple_Pack(5, __pyx_n_s_p_now, __pyx_n_s_marginal_now, __pyx_n_s_Ly, __pyx_n_s_N, __pyx_n_s_dx); if (unlikely(!__pyx_tuple__22)) __PYX_ERR(0, 26, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_tuple__22);
  __Pyx_GIVEREF(__pyx_tuple__22);
  __pyx_codeobj__23 = (PyObject*)__Pyx_PyCode_New(5, 0, 5, 0, CO_OPTIMIZED|CO_NEWLOCALS, __pyx_empty_bytes, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_tuple__22, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_kp_s_utilities_pyx, __pyx_n_s_calc_derivative_pxgy, 26, __pyx_empty_bytes); if (unlikely(!__pyx_codeobj__23)) __PYX_ERR(0, 26, __pyx_L1_error)
 ...
 *     double[:, :] p_last,
 */
  __pyx_tuple__24 = PyTuple_Pack(7, __pyx_n_s_p_now, __pyx_n_s_p_last, __pyx_n_s_drift_at_pos, __pyx_n_s_diffusion_at_pos, __pyx_n_s_N, __pyx_n_s_dx, __pyx_n_s_dt); if (unlikely(!__pyx_tuple__24)) __PYX_ERR(0, 34, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_tuple__24);
  __Pyx_GIVEREF(__pyx_tuple__24);
  __pyx_codeobj__25 = (PyObject*)__Pyx_PyCode_New(7, 0, 7, 0, CO_OPTIMIZED|CO_NEWLOCALS, __pyx_empty_bytes, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_tuple__24, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_kp_s_utilities_pyx, __pyx_n_s_step_probability_X, 34, __pyx_empty_bytes); if (unlikely(!__pyx_codeobj__25)) __PYX_ERR(0, 34, __pyx_L1_error)
